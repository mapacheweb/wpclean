...
add_action('after_switch_theme', function() {
  ...
  if ( ! term_exists('amenidad-card', 'grupo_amenidad') ) {
    wp_insert_term('Amenidad Card', 'grupo_amenidad', [
      'slug' => 'amenidad-card',
    ]);
  }
});
...
function hotel_habitacion_meta_box($post) {
  ...
  <div class="hotel-meta">
    <table class="form-table">
      ...
      <tr>
        <th><label for="hab_descripcion_larga">Descripción del titulo</label></th>
        <td>
